...
function Artefact({ src, alt, width, height, caption, imageClassName = 'h-auto w-full' }: { src: string; alt: string; width: number; height: number; caption: string; imageClassName?: string }) {
  return (
    <figure className="overflow-hidden rounded-xl border border-burgundy/10 bg-white shadow-sm">
  ...
  return (
    <div className="bg-ivory">
      ...
      <CaseStudySection title="Research"><div className="container-wide space-y-8">
        ...
        <Artefact src="/projects/bulk-market/BULK MARKET RESEARCH FINDINGS.png" alt="Bulk-Market research findings showing trust, price comparison, travel barriers, willingness to adopt, and preferred trust signals" width={1448} height={1086} caption="Survey findings informing the marketplace trust and discovery strategy" />
        <Artefact src="/projects/bulk-market/BULK MARKET COMPETITOR ANALYSIS.png" alt="Bulk-Market competitor analysis comparing physical markets, WhatsApp and Facebook groups, trusted suppliers, Jumia, Kikuu and Alibaba" width={1448} height={1086} caption="Competitor analysis connecting existing alternatives to product opportunities" />
      </div></CaseStudySection>

      <CaseStudySection title="Key Insight" backgroundLight><div className="container-wide space-y-8"><InsightCard highlighted><p className="text-3xl md:text-4xl font-bold leading-tight text-near-black">“Users were not necessarily loyal to WhatsApp, phone calls, or physical markets. They were loyal to the trust those channels provided.”</p></InsightCard><Artefact src="/projects/bulk-market/BULK MARKET RESEARCH SYNTHESIS.png" alt="Bulk-Market research synthesis summarising recurring user needs, trust barriers, evidence, and product implications" width={1448} height={1086} caption="Research synthesis connecting participant evidence to product priorities" /></div></CaseStudySection>
      ...
      <CaseStudySection title="Buyer Journey"><div className="container-wide space-y-8"><InsightCard label="Journey"><Flow steps={['Landing', 'Sign Up', 'Buyer Onboarding', 'Marketplace', 'Browse', 'Search', 'Filter', 'Product Detail', 'Purchase Flow']} /></InsightCard><p className="body-large text-grey-secondary max-w-3xl">I worked directly on the onboarding and discovery experience.</p><div className="space-y-6 overflow-hidden"><Artefact src="/projects/bulk-market/BULK MARKET BUYER  SCREENS 1.png" alt="Bulk-Market buyer registration and onboarding journey from welcome screen through account verification and access" width={3324} height={1076} caption="Buyer access and onboarding journey" /><Artefact src="/projects/bulk-market/BULK MARKET BUYER  SCREENS 2.png" alt="Bulk-Market buyer journey from product discovery through filtering, seller evaluation, cart, checkout and secure payment" width={3286} height={1718} caption="Buyer discovery, comparison and protected purchase journey" /><Artefact src="/projects/bulk-market/BULK MARKET BUYER  SCREENS 3.png" alt="Bulk-Market buyer journey through payment confirmation, order tracking, delivery status, ratings and post-order actions" width={3004} height={1192} caption="Buyer payment confirmation and post-order journey; exploratory concepts shown are not part of the committed MVP" /></div></div></CaseStudySection>

      <CaseStudySection title="Seller Journey" backgroundLight><div className="container-wide space-y-8"><InsightCard label="Journey"><Flow steps={['Landing', 'Seller Registration', 'Seller Onboarding', 'Marketplace Access', 'Product Listing']} /></InsightCard><p className="body-large text-grey-secondary max-w-3xl">I worked directly on seller onboarding and product listing.</p><div className="space-y-6 overflow-hidden"><Artefact src="/projects/bulk-market/BULK MARKET SELLER  SCREENS.png" alt="Bulk-Market seller journey from registration through business verification and verification status" width={3304} height={1550} caption="Seller registration, onboarding and verification journey" /><Artefact src="/projects/bulk-market/BULK MARKET SELLER  SCREENS 2.png" alt="Bulk-Market seller journey across dashboard access, product listing, MOQ and pricing setup, inventory and order management" width={3334} height={1410} caption="Seller catalogue, pricing, inventory and order-management journey" /><Artefact src="/projects/bulk-market/BULK MARKET SELLER  SCREENS 3.png" alt="Bulk-Market seller journey through fulfilment updates, dispute response, escrow, reviews and shop analytics" width={3360} height={1456} caption="Seller fulfilment, dispute, escrow and performance-management journey" /></div></div></CaseStudySection>

      <CaseStudySection title="Low-Fidelity Wireframing"><div className="container-wide space-y-8"><InsightCard label="Tool · Miro"><BulletList items={['Screen structure', 'Information hierarchy', 'Navigation', 'User progression', 'Interaction logic']} /></InsightCard><Artefact src="/projects/bulk-market/BULK MARKET LOW FIDELITY  SCREENS.png" alt="Bulk-Market low-fidelity Miro wireframes mapping early marketplace screens, navigation and buyer and seller progression" width={2816} height={1400} caption="Low-fidelity flow used to establish screen structure and interaction logic before high-fidelity design" /></div></CaseStudySection>
