...
export default function FoodSaverCaseStudy() {
  return (
    <div className="bg-ivory">
      ...
      <CaseStudySection title="Core User Journey"><div className="container-wide space-y-8"><InsightCard label="Central Flow" highlighted><Flow steps={['Launch', 'Register / Sign In', 'Browse', 'View Deal', 'Reserve', 'Pay', 'Confirm', 'Pick Up']} /></InsightCard><Artefact src="/projects/foodsaver/FOODSAVER COMPLETE USER JOURNEYS_FLOWS.jpg" alt="FoodSaver consumer and seller journey showing food discovery, reservation, checkout, pickup, listing creation and order management" width={2651} height={1508} caption="Connected consumer journey, seller journey and shared marketplace loop" scrollOnMobile /></div></CaseStudySection>

      <CaseStudySection title="Low-Fidelity Wireframes" backgroundLight><div className="container-wide space-y-8"><p className="body-large text-grey-secondary max-w-3xl">The wireframes helped establish hierarchy, navigation, sequence, and information placement.</p><div className="glass-panel rounded-xl p-6 md:p-8 flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between"><div><p className="eyebrow mb-2">Miro Wireframes</p><p className="body-default text-grey-secondary max-w-2xl">Explore the approved source board documenting the early FoodSaver screen structure and flow.</p></div><a href="https://miro.com/app/board/uXjVHD2Tpcg=/?share_link_id=121010577407" target="_blank" rel="noopener noreferrer" className="button-secondary inline-flex items-center justify-center gap-2 text-center"><span>Explore Low-Fidelity Wireframes</span><span aria-hidden="true">↗</span></a></div></div></CaseStudySection>
      ...
      <CaseStudySection title="Prototype Overview"><div className="container-wide"><div className="mx-auto max-w-2xl"><Artefact src="/projects/foodsaver/FOODSAVER PROTOTYPE OVERVIEW PREVIEW.png" alt="FoodSaver prototype preview introducing discounted food discovery and the product’s sustainability value proposition" width={766} height={1356} caption="Prototype interface shown with illustrative demo data." imageClassName="mx-auto h-auto w-full max-w-[38rem] object-contain" /></div></div></CaseStudySection>
